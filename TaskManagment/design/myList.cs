    ...
    internal class myList : Panel
    {
        ...
        public myList(string query, string table, Action<string,string> buttonFunc)
        {
            ...
            foreach (List<string> lineData in dataFromDatabase)
            {
                ...
                linePanel.BackColor = Color.FromArgb(216, 226, 235);
                ...
                button.ForeColor = Color.FromArgb(136, 151, 170);
                button.Font = new Font(button.Font.FontFamily, 32, FontStyle.Regular);
